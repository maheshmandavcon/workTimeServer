using WorkTime.Application.Common.Models;
using WorkTime.Application.TodoItems.Commands.CreateTodoItem;
using WorkTime.Application.TodoItems.Commands.DeleteTodoItem;
using WorkTime.Application.TodoItems.Commands.UpdateTodoItem;
using WorkTime.Application.TodoItems.Commands.UpdateTodoItemDetail;
using WorkTime.Application.TodoItems.Queries.GetTodoItemsWithPagination;

namespace WorkTime.Web.Endpoints;
